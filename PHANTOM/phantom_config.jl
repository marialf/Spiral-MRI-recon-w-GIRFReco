...
params_general[:recon_id] = "2024-11-28_12_00_00";
...
params_general[:recon_size] = [192, 192, 1] # 192 for all phantom images
...
params_general[:map_scan_filename] = "Cartesian-fieldmap-scan/32ch_phantom_fm_converted.h5" # Cartesian dual-echo file, for coil and B₀ maps calculation [Input]
params_general[:map_scan_filename_stem] = "32ch_phantom_fm_converted.h5"
# The different TEs from 220523_Maren.pdf / Contrast - Common
params_general[:mapTEs_ms] = [4.08, 5.1] 

 # File name for the spiral gradient [Input] # Try nominal gradient
params_general[:gradient_filename] = joinpath("k_meas_140mm1p71mmR1.txt") #"ArbGradientRO_140mm1p71mmR1.txt" );
#  non-Cartesian (Spiral) scan file: MDDW30
params_general[:scan_filename] = ["Spirals/32ch_140mm1p71mmR1.h5"] # ISMRMRD Raw k-space data for spiral acquisition [Input]

#Output files

params_general[:scan_filename_stem] = "phantom_140mm1p71mmR1.h5" # Main file name when saving the result
params_general[:processed_map_scan_filename] = "phantom_processed_cartesian_data.h5" # file name for preprocessed data (remove oversampling, permute dimensions wrt MRIReco) [Output]
